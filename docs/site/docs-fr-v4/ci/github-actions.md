...
La manière la plus simple d'utiliser FerrFlow dans GitHub Actions est l'action `FerrLabs/ferrflow@v4`. Elle installe le binaire et exécute `ferrflow release` automatiquement.
